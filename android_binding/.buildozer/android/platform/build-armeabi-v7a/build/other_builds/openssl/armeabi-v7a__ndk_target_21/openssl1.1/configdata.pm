...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "/Users/rohangupta/.buildozer/android/platform/android-ndk-r19b/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CFLAGS => [ "-Wall -O3" ],
  CPPDEFINES => [ "__ANDROID_API__=21" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "/Users/rohangupta/.buildozer/android/platform/android-ndk-r19b/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "Configurations/00-base-templates.conf", "Configurations/10-main.conf", "Configurations/15-android.conf", "Configurations/shared-info.pl" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/Users/rohangupta/.buildozer/android/platform/android-ndk-r19b/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  minor => "1.1",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -target armv7a-linux-androideabi -gcc-toolchain \$(ANDROID_NDK)/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64 --sysroot=\$(ANDROID_NDK)/platforms/android-21/arch-arm",
  ...
  cpuid_obj => "mem_clr.o",
  cxxflags => "-std=c++11 -pthread  -target armv7a-linux-androideabi -gcc-toolchain \$(ANDROID_NDK)/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64 --sysroot=\$(ANDROID_NDK)/platforms/android-21/arch-arm",
  defines => [  ],
